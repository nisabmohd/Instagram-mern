          ...
          >
            ...
            <DialogContent style={{ width: '100%' }}>
              <div className="post" style={{ width: '40vw', height: '70vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <input onChange={e => upload(e)} id="upload" type="file" hidden />
                <label htmlFor="upload">
                  <button style={{ border: 'none', outline: 'none', background: 'blue', padding: '3.5px 9px', borderRadius: '5px', color: 'white', backgroundColor: '#2196f3', marginTop: '12px',fontSize:'15px' }}>Select from computer</button></label>
              </div>
            </DialogContent>
