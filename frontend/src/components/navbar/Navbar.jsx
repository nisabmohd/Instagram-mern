          ...
          >
            ...
            <DialogContent style={{ width: '100%' }}>
              <div className="post" style={{ width: '40vw', height: '70vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                ...
                {
                  imgurl ? <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%' }}>
                    <div className="imageup">
                      <img style={{ width: '300px' }} src={imgurl} alt="" />
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', maxWidth: '50%',minWidth:'50%', marginLeft: '20px' }}>
                      <textarea value={caption} onChange={e=>setCaption(e.target.value)} type="text" placeholder="Enter caption" style={{ height: '105px', width: '360px', margin: 'auto', outline: 'none', border: '1px solid gray', padding: '6px 5px', fontSize: '14px', marginTop: '12px' }} />
