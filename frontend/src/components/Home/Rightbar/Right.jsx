        ...
        <div style={{ marginTop: '15px' }}>
            <div className="my-acc" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                <div className="img" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                    <img src="https://firebasestorage.googleapis.com/v0/b/upload-pics-e599e.appspot.com/o/images%2F05407c79-a3dc-46d0-bc35-2b0b0a59374d.png?alt=media&token=65e0ba5c-5b86-463f-8364-d4f4ebc1ad8a" style={{ width: '60px', borderRadius: '50%' }} alt="" />
                    <div className="name" style={{ display: 'flex', flexDirection: 'column', marginLeft: '18px' }}>
                        <p style={{ color: 'black', fontSize: '14.75px', fontWeight: 'bold' }}>nisabmohd</p>
                        <p style={{ color: 'gray', fontSize: '14.75px', marginTop: '9px' }}>Nisab Mohd</p>
                    </div>
                </div>
